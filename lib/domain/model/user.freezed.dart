...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, firstName: $firstName, lastName: $lastName, userName: $userName, email: $email, password: $password, signUpDate: $signUpDate)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, firstName, lastName,
      userName, email, password, signUpDate);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final String signUpDate}) = _$UserImpl;
